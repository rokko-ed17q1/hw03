...
Although you may assume that the parameter `x` is alway square (probably because input validation is done outside of the function), you can make an extra effor to validate that `x` is really square within this function. 
